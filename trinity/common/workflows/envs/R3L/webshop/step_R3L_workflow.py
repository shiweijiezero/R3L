# -*- coding: utf-8 -*-
"""Step-level R3L (Reflect-then-Retry RL) workflow for WebShop with Qwen3 compatibility.
...
@WORKFLOWS.register_module("step_R3L_webshop_workflow")
class StepLevelR3LWebshopWorkflow(StepLevelWebshopBaseWorkflow):
    """Step-level R3L for WebShop.
    ...
    def _get_reflect(self, trajectory):
        ...
        try:
            ...
            print(f"[StepR3L-WebShop] Reflection failed: {e}")
    ...
    def _run_retry_from_pivot(
        ...
        Steps 0..pivot-1: Replay environment using base trajectory actions.
        Steps pivot..end: Generate new model responses with guidance.
        """
        self._reset_for_rollout()
        original_system = self.webshop_system_template.render()
        action_history = []
                ...
                if msg["role"] == "user":
                    ...
                    if first_step < pivot_step:
                        ...
                        if think is not None and action is not None:
                            ...
                            action_valid, _ = utils.validate_action(action, available_actions)
                            if action_valid:
    ...
    def run(self) -> List[Experience]:
        ...
        for i in range(self.n // 2):
            try:
                ...
                print(
                    f"[StepR3L-WebShop] Base rollout {i} - "
                ...
                print(f"[StepR3L-WebShop] Pivot point: {pivot_step}")
                ...
                print(
                    f"[StepR3L-WebShop] Retry rollout {i} - reward: {retry_reward}, "
                ...
                if (retry_reward > base_reward and retry_reward >= 1.0) or (
                    ...
                    if sft_retry_exps:
                        ...
                        print("[StepR3L-WebShop] Recorded reflect + retry SFT data")

            except Exception as e:
                print(f"[StepR3L-WebShop] Iteration {i} failed: {e}")
