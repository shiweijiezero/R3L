...
@WORKFLOWS.register_module("opmd_baseline_qwen_math_workflow")
class OPMDBaselineQwenMathWorkflow(Workflow):
    """
    OPMD Baseline workflow for Qwen Math problem solving.
    ...
    def __init__(
        ...
        self.data_dir = "opmd_baseline_qwen_math_data"
        ...
        print(f"Initializing OPMDBaselineQwenMathWorkflow, temperature={self.temperature}")
        self.reset(task)
    ...
    def run(self) -> List[Experience]:
        ...
        for i in range(self.n):
            try:
                ...
                print(f"[OPMD-Qwen] First rollout - reward: {reward}, attempts: {attempts}")
