...
@WORKFLOWS.register_module("raft_baseline_qwen_math_workflow")
class RAFTBaselineQwenMathWorkflow(Workflow):
    """
    RAFT Baseline workflow for Qwen Math problem solving.
    ...
    def __init__(
        ...
        self.data_dir = "raft_baseline_qwen_math_data"
        ...
        print(f"Initializing RAFTBaselineQwenMathWorkflow, temperature={self.temperature}")
        self.reset(task)
    ...
    def run(self) -> List[Experience]:
        ...
        for i in range(self.n):
            try:
                ...
                print(f"[RAFT-Qwen] First rollout - reward: {reward}, attempts: {attempts}")
