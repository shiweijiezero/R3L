# -*- coding: utf-8 -*-
"""Step-level Reflect-GRPO workflow for ScienceWorld with Qwen3 compatibility."""
import json
...
@WORKFLOWS.register_module("step_reflect_grpo_scienceworld_workflow")
class StepLevelReflectGRPOScienceWorldWorkflow(StepLevelScienceWorldBaseWorkflow):
    """Step-level Reflect-GRPO for ScienceWorld.
    ...
    def _get_reflect(self, trajectory):
        ...
        try:
            ...
            print(f"[StepReflectGRPO-SciWorld] Reflection failed: {e}")
    ...
    def _run_retry_from_beginning(self, guidance_prompt, run_id):
        ...
        try:
            ...
            print(f"[StepReflectGRPO-SciWorld] Retry rollout failed: {e}")
            return []
    ...
    def run(self) -> List[Experience]:
        ...
        for i in range(self.n // 2):
            ...
            if run_exps:
                ...
                print(
                    f"[StepReflectGRPO-SciWorld] Rollout {i} - "
                    f"reward: {self.final_reward / 100.0}"
                )
        ...
        for i in range(self.n // 2):
            ...
            if base_exps:
                ...
                print(
                    f"[StepReflectGRPO-SciWorld] First attempt {i} - reward: {base_reward}"
                )
            ...
            if base_reward < 1.0:
                ...
                if is_valid and not is_perfect:
                    ...
                    if retry_exps:
                        ...
                        retry_reward = self.final_reward / 100.0
                        print(
                            f"[StepReflectGRPO-SciWorld] Retry {i} - reward: {retry_reward}, "
                            f"improved: {retry_reward > base_reward}"
                        )
