# -*- coding: utf-8 -*-
"""Step-level Reflect-GRPO workflow for WebShop with Qwen3 compatibility."""
import json
...
@WORKFLOWS.register_module("step_reflect_grpo_webshop_workflow")
class StepLevelReflectGRPOWebshopWorkflow(StepLevelWebshopBaseWorkflow):
    """Step-level Reflect-GRPO for WebShop.
    ...
    def _get_reflect(self, trajectory):
        ...
        try:
            ...
            print(f"[StepReflectGRPO-WebShop] Reflection failed: {e}")
    ...
    def _run_retry_from_beginning(self, guidance_prompt, run_id):
        ...
        try:
            ...
            print(f"[StepReflectGRPO-WebShop] Retry rollout failed: {e}")
            return []
    ...
    def run(self) -> List[Experience]:
        ...
        for i in range(self.n // 2):
            ...
            if run_exps:
                ...
                print(
                    f"[StepReflectGRPO-WebShop] Rollout {i} - reward: {self.final_reward}"
                )
        ...
        for i in range(self.n // 2):
            ...
            if base_exps:
                ...
                print(
                    f"[StepReflectGRPO-WebShop] First attempt {i} - reward: {base_reward}"
                )
            ...
            if base_reward < 1.0:
                ...
                if is_valid and not is_perfect:
                    ...
                    if retry_exps:
                        ...
                        print(
                            f"[StepReflectGRPO-WebShop] Retry {i} - reward: {self.final_reward}, "
